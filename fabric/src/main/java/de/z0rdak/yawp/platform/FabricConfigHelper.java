...
public class FabricConfigHelper implements IConfigHelper {
    ...
    private void registerModConfig(ModConfigSpec spec, ModConfig.Type type, String configName) {
        fuzs.forgeconfigapiport.fabric.api.v5.ConfigRegistry.INSTANCE.register(MOD_ID, type, spec, configName);
    }

    public void register() {
        ModConfigEvents.loading(MOD_ID).register(FabricConfigHelper::onModLoading);
        ModConfigEvents.reloading(MOD_ID).register(FabricConfigHelper::onModReloading);

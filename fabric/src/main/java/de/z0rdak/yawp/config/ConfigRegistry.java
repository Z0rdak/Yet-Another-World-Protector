...
public final class ConfigRegistry {
    ...
    public static void register() {
        ...
        ForgeConfigRegistry.INSTANCE.register(MOD_ID, ModConfig.Type.COMMON, PermissionConfig.CONFIG_SPEC, PermissionConfig.CONFIG_NAME);
        ForgeConfigRegistry.INSTANCE.register(MOD_ID, ModConfig.Type.COMMON, FlagConfig.CONFIG_SPEC, FlagConfig.CONFIG_NAME);
        ForgeConfigRegistry.INSTANCE.register(MOD_ID, ModConfig.Type.COMMON, RegionConfig.CONFIG_SPEC, RegionConfig.CONFIG_NAME);
        ForgeConfigRegistry.INSTANCE.register(MOD_ID, ModConfig.Type.COMMON, LoggingConfig.CONFIG_SPEC, LoggingConfig.CONFIG_NAME);
    }

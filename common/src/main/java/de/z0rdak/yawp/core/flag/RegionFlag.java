...
public enum RegionFlag {
    ...
    FLUID_FLOW("fluid-flow", FlagType.BOOLEAN_FLAG, Collections.singletonList(FlagCategory.ENVIRONMENT)),
    ...
    LAVA_FLOW("lava-flow", FlagType.BOOLEAN_FLAG, Collections.singletonList(FlagCategory.ENVIRONMENT)),
    ...
    NO_ITEM_DESPAWN("no-item-despawn", FlagType.BOOLEAN_FLAG, Arrays.asList(FlagCategory.ITEM, FlagCategory.PROTECTION)),

...
public class LoggingConfig {
    ...
    */
    ...
    public static boolean logCheck(NeoForgeFlagCheckEvent check) {
    ...
    public static NeoForgeFlagCheckResult logResult(NeoForgeFlagCheckResult result) {
        NeoForgeFlagCheckEvent check = result.getFlagCheck();
        boolean matchesFlagOrCategory = (flagMatchesCategory(check) || matchesFlag(check));
    ...
    public static boolean matchesResult(NeoForgeFlagCheckResult result) {
        return LoggingConfig.getResultValuesToLog().contains(result.getFlagState().name);
    }

    public static boolean flagMatchesCategory(NeoForgeFlagCheckEvent check) {
        return RegionFlag.matchesCategory(check.getRegionFlag(), getFlagCategories());
    }

    public static boolean matchesFlag(NeoForgeFlagCheckEvent check) {

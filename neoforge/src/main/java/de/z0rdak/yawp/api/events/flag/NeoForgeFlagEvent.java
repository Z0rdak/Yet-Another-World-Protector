...
public abstract class NeoForgeFlagEvent extends Event {
    ...
    private NeoForgeFlagEvent(final CommandSourceStack src, final IProtectedRegion region, final IFlag flag) {
        this.src = src;
        this.region = region;
        this.flag = flag;
    }
    ...
    public static class AddFlagEvent extends NeoForgeFlagEvent {
    ...
    public static class RemoveFlagEvent extends NeoForgeFlagEvent {
    ...
    public static class UpdateFlagMessageEvent extends NeoForgeFlagEvent {

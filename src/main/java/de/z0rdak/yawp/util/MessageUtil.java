...
public class MessageUtil {
    ...
    public static MutableComponent buildTeamHoverComponent(Team team) {
        ...
        playerName.setStyle(playerName.getStyle()
                .withColor(LINK_COLOR)
                .withHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, new TranslatableComponent("cli.msg.info.region.affiliation.link.hover")))
    ...
    public static MutableComponent buildAddAffiliateLink(IProtectedRegion region, String affiliation, AffiliationType affiliationType, RegionType regionType) {
        ...
        MutableComponent hoverText = new TranslatableComponent("cli.msg.info.region.affiliation." + affiliationType.name + ".add.link.hover", affiliation, region.getName());
    ...
    public static MutableComponent buildAffiliationHeader(IProtectedRegion region, String affiliation, RegionType regionType) {
        ...
        return buildHeader(new TranslatableComponent("cli.msg.info.header.in", affiliationLink, buildRegionInfoLink(region, regionType)));
    }
    ...
    public static MutableComponent buildAffiliationHeader(IProtectedRegion region, String affiliation, AffiliationType affiliationType, RegionType regionType) {
        return new TranslatableComponent("cli.msg.info.region.affiliation." + affiliationType.name + ".list", buildRegionInfoLink(region, regionType), affiliation);
    }
    ...
    private static MutableComponent buildFlagQuickInfo(IFlag flag) {
    ...
    public static List<MutableComponent> buildPaginationComponents(MutableComponent description, String cmd, List<MutableComponent> entries, int pageNo, MutableComponent addEmptyLink) {
        ...
        MutableComponent first = hasMultiplePages && pageNo != FIRST_PAGE_IDX
                ? buildExecuteCmdComponent(new TextComponent(PAGINATION_FIRST), new TranslatableComponent("cli.msg.info.pagination.first"), buildPageCommand(cmd, FIRST_PAGE_IDX), RUN_COMMAND, LINK_COLOR)
                : ComponentUtils.wrapInSquareBrackets(new TextComponent(PAGINATION_FIRST)).withStyle(INACTIVE_LINK_COLOR);
        MutableComponent prev = hasMultiplePages && pageNo > FIRST_PAGE_IDX
                ? buildExecuteCmdComponent(new TextComponent(PAGINATION_PREVIOUS), new TranslatableComponent("cli.msg.info.pagination.previous"), buildPageCommand(cmd, Math.max(pageNo - 1, FIRST_PAGE_IDX)), RUN_COMMAND, LINK_COLOR)
                : ComponentUtils.wrapInSquareBrackets(new TextComponent(PAGINATION_PREVIOUS)).withStyle(INACTIVE_LINK_COLOR);
        MutableComponent next = hasMultiplePages && pageNo < numberOfPages - 1
                ? buildExecuteCmdComponent(new TextComponent(PAGINATION_NEXT), new TranslatableComponent("cli.msg.info.pagination.next"), buildPageCommand(cmd, Math.min(pageNo + 1, numberOfPages - 1)), RUN_COMMAND, LINK_COLOR)
                : ComponentUtils.wrapInSquareBrackets(new TextComponent(PAGINATION_NEXT)).withStyle(INACTIVE_LINK_COLOR);
        MutableComponent last = hasMultiplePages && pageNo < numberOfPages - 1
                ? buildExecuteCmdComponent(new TextComponent(PAGINATION_LAST), new TranslatableComponent("cli.msg.info.pagination.last"), buildPageCommand(cmd, numberOfPages - 1), RUN_COMMAND, LINK_COLOR)
                : ComponentUtils.wrapInSquareBrackets(new TextComponent(PAGINATION_LAST)).withStyle(INACTIVE_LINK_COLOR);
    ...
    public static MutableComponent buildRegionChildrenLink(IProtectedRegion region, RegionType type) {
        return switch (type) {
            case DIMENSION -> {
                ...
                MutableComponent listDimRegionsLinkText = new TranslatableComponent("cli.msg.dim.info.region.list.link.text", region.getChildren().size());
    ...
    public static MutableComponent buildDimAddFlagLink(IProtectedRegion dimRegion) {
        ...
        MutableComponent hoverText = new TranslatableComponent("cli.msg.dim.flag.add.link.hover", dimRegion.getDim().location().toString());
        MutableComponent linkText = new TranslatableComponent("cli.link.add");
    ...
    public static MutableComponent buildRegionAddFlagLink(IProtectedRegion region) {
        ...
        MutableComponent flagAddHoverText = new TranslatableComponent("cli.msg.info.region.flag.add.link.hover", region.getName());
        MutableComponent flagAddLinkText = new TranslatableComponent("cli.link.add");
    ...
    public static MutableComponent buildRemoveAffiliateEntry(IProtectedRegion region, String affiliateName, AffiliationType affiliationType, String affiliation, RegionType regionType) {
        MutableComponent linkText = new TranslatableComponent("cli.link.remove");
        MutableComponent hoverText = new TranslatableComponent("cli.msg.info.region.affiliation." + affiliationType.name + ".remove.link.hover", affiliateName, region.getName());
    ...
    public static MutableComponent buildAffiliateInfo(IProtectedRegion region, String affiliateName, AffiliationType affiliationType) {
        return switch (affiliationType) {
            case PLAYER -> {
                ...
                yield player == null
                        ? new TextComponent(affiliateName).withStyle(GRAY).append(" ").append(new TranslatableComponent("cli.msg.info.player.list.entry.offline"))
            ...
            case TEAM -> {
                ...
                if (level != null) {
                    ...
                    yield team == null ? new TextComponent(affiliateName) : buildTeamHoverComponent(team);
                } else {
                    yield new TextComponent(affiliateName);
                }
            }
        };
    }

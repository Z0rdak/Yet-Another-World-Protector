...
public class MessageUtil {
    ...
    public static void sendCmdFeedback(ServerCommandSource src, MutableText text) {
        try {
            if (src.getEntity() == null) {
                ...
                sendMessage(src.getPlayer(), text);
            }
    ...
    public static void sendCmdFeedback(ServerCommandSource src, String langKey) {
        sendCmdFeedback(src, new TranslatableText(langKey));
    }
    ...
    public static void sendMessage(PlayerEntity player, String translationKey) {
        player.sendMessage(new TranslatableText(translationKey), false);
    }

    public static void sendDimFlagNotification(PlayerEntity player, RegionFlag flag) {
        player.sendMessage(new TranslatableText("flag.dim.player.msg.push.deny", flag.name), true);
    }

    public static void sendFlagNotification(PlayerEntity player, IMarkableRegion region, RegionFlag flag) {
        player.sendMessage(new TranslatableText("flag.local.player.msg.push.deny", region.getName(), flag.name), true);
    }
    ...
    public static MutableText buildHeader(String translationKey) {
        return buildHeader(new TranslatableText(translationKey));
    }

    public static MutableText buildHeader(MutableText header) {
        return new LiteralText((BOLD + ""))
                .append(header)
                .append(new LiteralText((BOLD + "")));
    }
    ...
    public static MutableText buildExecuteCmdComponent(String linkText, String hoverText, String command, ClickEvent.Action eventAction, Formatting color) {
        MutableText text = Texts.bracketed(new TranslatableText(linkText));
        return text.setStyle(text.getStyle()
                .withColor(color)
                .withClickEvent(new ClickEvent(eventAction, command))
                .withHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, new TranslatableText(hoverText))));
    }
    ...
    public static MutableText buildPlayerHoverComponent(PlayerEntity player) {
        ...
        MutableText playerName = new LiteralText((player.getEntityName()));
    ...
    public static MutableText buildTeamHoverComponent(Team team) {
        MutableText playerName = new LiteralText((team.getName()));
        playerName.setStyle(playerName.getStyle()
                .withColor(LINK_COLOR)
                .withHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, new TranslatableText("cli.msg.info.region.affiliation.link.hover")))
    ...
    public static MutableText buildRegionAreaDetailComponent(IMarkableRegion region) {
        ...
        MutableText areaInfo = new LiteralText((area.getAreaType().areaType))
                .append("\n");
    ...
    public static MutableText buildDimensionTeleportLink(IMarkableRegion region) {
        ...
        MutableText teleportCmdHoverText = new TranslatableText("cli.msg.info.region.spatial.location.teleport", region.getName(), region.getDim().getValue().toString());
        return buildExecuteCmdComponent(new LiteralText((cmdLinkText)), teleportCmdHoverText, executeCmdStr, RUN_COMMAND, TP_COLOR);
    }
    ...
    public static MutableText buildHelpSuggestionLink(String translationKey, CommandConstants baseCmd, CommandConstants cmd) {
        ...
        return new LiteralText((" "))
                ...
                .append(new TranslatableText(translationKey));
    }
    ...
    public static MutableText buildRegionPriorityComponent(IMarkableRegion region) {
        ...
        MutableText incLinkText = new TranslatableText("cli.msg.info.region.state.priority.increase.link.text", CLI_REGION_DEFAULT_PRIORITY_INC.get());
        MutableText incHoverText = new TranslatableText("cli.msg.info.region.state.priority.increase.link.hover", CLI_REGION_DEFAULT_PRIORITY_INC.get());
        ...
        MutableText decLinkText = new TranslatableText("cli.msg.info.region.state.priority.decrease.link.text", CLI_REGION_DEFAULT_PRIORITY_INC.get());
        MutableText decHoverText = new TranslatableText("cli.msg.info.region.state.priority.decrease.link.hover", CLI_REGION_DEFAULT_PRIORITY_INC.get());
        ...
        MutableText priorityValue = new LiteralText((String.valueOf(region.getPriority())));
        ...
        MutableText setPriorityLinkText = new TranslatableText("cli.msg.info.region.state.priority.set.link.text");
        MutableText setPriorityHoverText = new TranslatableText("cli.msg.info.region.state.priority.set.link.hover");
    ...
    public static MutableText buildRegionInfoLink(IProtectedRegion region, RegionType type) {
        return switch (type) {
            case DIMENSION -> {
                ...
                MutableText hoverText = new TranslatableText("cli.msg.dim.info");
                MutableText linkText = new LiteralText((region.getDim().getValue().toString()));
            ...
            case LOCAL -> {
                ...
                MutableText regionInfoLinkText = new LiteralText((region.getName()));
                MutableText regionInfoLinkHover = new TranslatableText("cli.msg.info.region", region.getName());
    ...
    public static MutableText buildRegionSpatialPropLink(IMarkableRegion region) {
        ...
        MutableText spatialPropLinkText = new TranslatableText("cli.msg.info.region.spatial.link.text");
        MutableText spatialPropHoverText = new TranslatableText("cli.msg.info.region.spatial.link.hover", region.getName());
    ...
    public static MutableText buildRegionOverviewHeader(IProtectedRegion region, RegionType type) {
        return switch (type) {
            case DIMENSION -> {
                ...
                yield buildHeader(new TranslatableText("cli.msg.info.header.for", clipBoardDumpLink, buildRegionInfoLink(region, RegionType.DIMENSION)));
            }
            case LOCAL -> {
                ...
                yield buildHeader(new TranslatableText("cli.msg.info.header.for", clipBoardDumpLink, buildRegionInfoLink(region, LOCAL)));
            }
            default -> throw new IllegalStateException("Unexpected value: " + type);
        };
    }
    ...
    public static MutableText buildBlockPosTpLinks(IMarkableRegion region) {
        ...
        MutableText blockPosTpLinkList = new LiteralText((""));
    ...
    public static MutableText buildPlayerListLink(IProtectedRegion region, PlayerContainer players, String affiliation, RegionType regionType) {
        MutableText hoverText = new TranslatableText("cli.msg.info.region.affiliation.player.list.link.hover", affiliation, region.getName());
        MutableText linkText = new TranslatableText("cli.msg.info.region.affiliation.player.list.link.text", players.getPlayers().size());
    ...
    public static MutableText buildTeamListLink(IProtectedRegion region, PlayerContainer teams, String affiliation, RegionType regionType) {
        MutableText hoverText = new TranslatableText("cli.msg.info.region.affiliation.team.list.link.hover", affiliation, region.getName());
        MutableText linkText = new TranslatableText("cli.msg.info.region.affiliation.team.list.link.text", teams.getTeams().size());
        return switch (regionType) {
            case DIMENSION -> {
    ...
    public static MutableText buildAddAffiliateLink(IProtectedRegion region, String affiliation, AffiliationType affiliationType, RegionType regionType) {
        MutableText linkText = new TranslatableText("cli.link.add");
        MutableText hoverText = new TranslatableText("cli.msg.info.region.affiliation." + affiliationType.name + ".add.link.hover", affiliation, region.getName());
    ...
    public static MutableText buildAffiliationLinks(IProtectedRegion region, RegionType regionType) {
        MutableText affiliationLinks = new LiteralText((""));
    ...
    public static MutableText buildAffiliationHeader(IProtectedRegion region, String affiliation, RegionType regionType) {
        ...
        return buildHeader(new TranslatableText("cli.msg.info.header.in", affiliationLink, buildRegionInfoLink(region, regionType)));
    }
    ...
    public static MutableText buildAffiliationHeader(IProtectedRegion region, String affiliation, AffiliationType affiliationType, RegionType regionType) {
        return new TranslatableText("cli.msg.info.region.affiliation." + affiliationType.name + ".list", buildRegionInfoLink(region, regionType), affiliation);
    }
    ...
    public static MutableText buildAffiliationLink(IProtectedRegion region, String affiliation, int affiliationSize, RegionType regionType) {
        MutableText linkText = new TranslatableText("cli.msg.info.region.affiliation.list.link.text", affiliationSize, affiliation);
        MutableText hoverText = new TranslatableText("cli.msg.info.region.affiliation.list.link.hover", affiliation, region.getName());
        return switch (regionType) {
            case LOCAL -> {
    ...
    public static MutableText buildAffiliationTeamListLink(IProtectedRegion region, String affiliation, RegionType regionType) {
        ...
        MutableText teams = new TranslatableText("cli.msg.info.region.affiliation.team").append(": ");
        ...
        MutableText teamListLink = playerContainer.hasTeams()
                ...
                : new TranslatableText("cli.msg.info.region.affiliation.team.list.link.text", playerContainer.getTeams().size());
    ...
    public static MutableText buildAffiliationPlayerListLink(IProtectedRegion region, String affiliation, RegionType regionType) {
        // Players: [n player(s)] [+]
        PlayerContainer playerContainer = affiliation.equals("owner") ? region.getOwners() : region.getMembers();
        MutableText players = new TranslatableText("cli.msg.info.region.affiliation.player").append(": ");
        ...
        MutableText playerListLink = playerContainer.hasPlayers()
                ...
                : new TranslatableText("cli.msg.info.region.affiliation.player.list.link.text", playerContainer.getPlayers().size());
    ...
    private static MutableText buildRemoveFlagEntry(IProtectedRegion region, IFlag flag, RegionType regionType) {
        MutableText flagRemoveEntry = new LiteralText((" - "));
        MutableText flagRemoveLink = switch (regionType) {
            case DIMENSION -> {
                ...
                MutableText hoverText = new TranslatableText("cli.msg.dim.info.flag.remove.link.hover", flag.getFlagIdentifier(), region.getDim().getValue().toString());
                MutableText linkText = new TranslatableText("cli.link.remove");
            ...
            case LOCAL -> {
                ...
                MutableText hoverText = new TranslatableText("cli.msg.info.region.flag.remove.link.hover", flag.getFlagIdentifier(), region.getName());
                MutableText linkText = new TranslatableText("cli.link.remove");
    ...
    public static MutableText buildFlagQuickInfo(IFlag flag) {
        return switch (flag.getFlagType()) {
            case BOOLEAN_FLAG -> {
                ...
                MutableText flagName = new LiteralText((boolFlag.getFlagIdentifier()));
                MutableText flagInfo = new LiteralText(("Flag state: Active=" + boolFlag.isActive() + ", negated=" + boolFlag.isInverted()));
    ...
    public static MutableText buildFlagCmdInfoLink(IProtectedRegion region, RegionType regionType, IFlag iflag) {
        ...
        return new LiteralText(iflag.getFlagIdentifier());
    }
    ...
    public static MutableText buildRemoveRegionEntry(IProtectedRegion parent, IMarkableRegion region, RegionType parentType) {
        ...
        MutableText separator = new LiteralText((" ")).setStyle(resetStyle);
        MutableText regionRemoveLink = switch (parentType) {
            case DIMENSION -> {
                ...
                MutableText childIndicator = buildTextWithHoverMsg(new LiteralText(("*")), new TranslatableText("cli.msg.info.dim.region.child.hover"), GOLD);
                if (parent.hasChild(region)) {
                    removeLink.append(childIndicator.setStyle(childIndicator.getStyle().withInsertion("Test")));
                }
                removeLink.append(new LiteralText((" @ ")).setStyle(resetStyle)).append(buildRegionTeleportLink(region));
                yield removeLink;
            }
            case LOCAL ->
        ...
        return new LiteralText((" - ")).append(regionRemoveLink);
    }
    ...
    public static List<MutableText> buildPaginationComponents(MutableText description, String cmd, List<MutableText> entries, int pageNo, MutableText addEmptyLink) {
        ...
        if (pageNo < FIRST_PAGE_IDX || pageNo >= numberOfPages) {
            paginationComponents.add(new TranslatableText("cli.msg.info.pagination.error.index", pageNo, numberOfPages - 1).formatted(RED));
        ...
        MutableText first = hasMultiplePages && pageNo != FIRST_PAGE_IDX
                ? buildExecuteCmdComponent(new TranslatableText("cli.msg.info.pagination.first.text"), new TranslatableText("cli.msg.info.pagination.first.hover"), buildPageCommand(cmd, FIRST_PAGE_IDX), RUN_COMMAND, LINK_COLOR)
                : Texts.bracketed(new TranslatableText("cli.msg.info.pagination.first.text")).formatted(INACTIVE_LINK_COLOR);
        MutableText prev = hasMultiplePages && pageNo > FIRST_PAGE_IDX
                ? buildExecuteCmdComponent(new TranslatableText("cli.msg.info.pagination.previous.text"), new TranslatableText("cli.msg.info.pagination.previous.hover"), buildPageCommand(cmd, Math.max(pageNo - 1, FIRST_PAGE_IDX)), RUN_COMMAND, LINK_COLOR)
                : Texts.bracketed(new TranslatableText("cli.msg.info.pagination.previous.text")).formatted(INACTIVE_LINK_COLOR);
        MutableText next = hasMultiplePages && pageNo < numberOfPages - 1
                ? buildExecuteCmdComponent(new TranslatableText("cli.msg.info.pagination.next.text"), new TranslatableText("cli.msg.info.pagination.next.hover"), buildPageCommand(cmd, Math.min(pageNo + 1, numberOfPages - 1)), RUN_COMMAND, LINK_COLOR)
                : Texts.bracketed(new TranslatableText("cli.msg.info.pagination.next.text")).formatted(INACTIVE_LINK_COLOR);
        MutableText last = hasMultiplePages && pageNo < numberOfPages - 1
                ? buildExecuteCmdComponent(new TranslatableText("cli.msg.info.pagination.last.text"), new TranslatableText("cli.msg.info.pagination.last.hover"), buildPageCommand(cmd, numberOfPages - 1), RUN_COMMAND, LINK_COLOR)
                : Texts.bracketed(new TranslatableText("cli.msg.info.pagination.last.text")).formatted(INACTIVE_LINK_COLOR);
    ...
    public static MutableText buildRegionChildrenHeader(IProtectedRegion region, RegionType type) {
        return buildHeader(new TranslatableText("cli.msg.info.header.in", buildRegionChildrenLink(region, type), buildRegionInfoLink(region, type)));
    }
    ...
    public static MutableText buildRegionParentLink(IMarkableRegion region) {
        ...
        if (region.getParent() != null) { // FIXME: should not happen. it is either a dim or local region as parent
            ...
            MutableText parentLinkText = new TranslatableText("cli.msg.info.region.parent.link.text", region.getParent().getName());
            MutableText parentHoverText = new TranslatableText("cli.msg.info.region.parent.link.hover", region.getParent().getName());
            ...
            if (region.getParent() instanceof IMarkableRegion) {
                ...
                MutableText parentClearLinkText = new TranslatableText("cli.msg.info.region.parent.clear.link.text");
                MutableText parentClearHoverText = new TranslatableText("cli.msg.info.region.parent.clear.link.hover", region.getParent().getName());
            ...
            MutableText setParentLinkText = new TranslatableText("cli.link.add");
            MutableText setParentHoverText = new TranslatableText("cli.msg.info.region.parent.set.link.hover", region.getName());
            parentLink = new TranslatableText("cli.msg.info.region.parent.null")
                    .append(" ")
    ...
    public static MutableText buildDimRegionListHeader(DimensionalRegion dimRegion) {
        return buildHeader(new TranslatableText("cli.msg.info.header.in",
    ...
    public static MutableText buildRegionChildrenLink(IProtectedRegion region, RegionType type) {
        return switch (type) {
            case DIMENSION -> {
                ...
                MutableText listDimRegionsLinkText = new TranslatableText("cli.msg.dim.info.region.list.link.text", dimCache.getRegions().size());
                MutableText listDimRegionsHoverText = new TranslatableText("cli.msg.dim.info.region.list.link.hover", region.getName());
            ...
            case LOCAL -> {
                ...
                MutableText childrenLinkText = new TranslatableText("cli.msg.info.region.children.link.text", region.getChildren().size());
                MutableText childrenHoverText = new TranslatableText("cli.msg.info.region.children.link.hover", region.getName());
    ...
    public static MutableText buildRegionAddChildrenLink(IProtectedRegion region) {
        ...
        MutableText addChildrenLinkText = new TranslatableText("cli.link.add");
        MutableText addChildrenHoverText = new TranslatableText("cli.msg.info.region.children.add.link.hover", region.getName());
    ...
    public static MutableText buildDimCreateRegionLink(IProtectedRegion region) {
        ...
        MutableText createRegionLinkText = new TranslatableText("cli.link.add");
        MutableText createRegionHoverText = new TranslatableText("cli.msg.dim.info.region.create.link.hover", region.getName());
    ...
    public static MutableText buildFlagListLink(IProtectedRegion region, RegionType type) {
        MutableText flagLink = switch (type) {
            case DIMENSION -> {
                ...
                MutableText flagListLinkText = new TranslatableText("cli.msg.info.region.flag.link.text", region.getFlags().size());
                MutableText flagListHoverText = new TranslatableText("cli.msg.dim.flag.list.link.hover", region.getName());
            ...
            case LOCAL -> {
                ...
                MutableText flagListLinkText = new TranslatableText("cli.msg.info.region.flag.link.text", region.getFlags().size());
                MutableText flagListHoverText = new TranslatableText("cli.msg.info.region.flag.link.hover", region.getName());
    ...
    public static MutableText buildDimAddFlagLink(IProtectedRegion dimRegion) {
        ...
        MutableText hoverText = new TranslatableText("cli.msg.dim.flag.add.link.hover", dimRegion.getDim().getValue().toString());
        MutableText linkText = new TranslatableText("cli.link.add");
    ...
    public static MutableText buildRegionAddFlagLink(IProtectedRegion region) {
        ...
        MutableText flagAddHoverText = new TranslatableText("cli.msg.info.region.flag.add.link.hover", region.getName());
        MutableText flagAddLinkText = new TranslatableText("cli.link.add");
    ...
    public static MutableText buildRegionStateLink(IMarkableRegion region) {
        ...
        MutableText stateLinkText = new TranslatableText("cli.msg.info.region.state.link.text");
        MutableText stateHoverText = new TranslatableText("cli.msg.info.region.state.link.hover", region.getName());
    ...
    public static MutableText buildStateLink(IProtectedRegion region) {
        ...
        return new TranslatableText("cli.msg.info.state")
                .append(new LiteralText((": ")))
                .append(stateLink);
    }

    public static MutableText buildInfoComponent(String subjectLangKey, MutableText payload) {
        return new TranslatableText(subjectLangKey).append(": ").append(payload);
    }
    ...
    public static MutableText buildDimSuggestRegionRemovalLink(IMarkableRegion region) {
        ...
        MutableText hover = new TranslatableText("cli.msg.info.dim.region.remove.link.hover", region.getName());
        MutableText text = new TranslatableText("cli.link.remove");
    ...
    public static MutableText buildDimFlagListLink(IProtectedRegion region) {
        ...
        MutableText hoverLink = new TranslatableText("cli.msg.dim.flag.list.link.hover", region.getDim().getValue().toString());
        MutableText linkText = new TranslatableText("cli.msg.flag.list.link.text", region.getFlags().size());
        return region.getFlags().isEmpty()
                ? new TranslatableText("cli.msg.info.region.flag.link.text", region.getFlags().size())
    ...
    public static MutableText buildRemoveAffiliateEntry(IProtectedRegion region, String affiliateName, AffiliationType affiliationType, String affiliation, RegionType regionType) {
        MutableText linkText = new TranslatableText("cli.link.remove");
        MutableText hoverText = new TranslatableText("cli.msg.info.region.affiliation." + affiliationType.name + ".remove.link.hover", affiliateName, region.getName());
    ...
    public static MutableText buildAffiliateInfo(IProtectedRegion region, String affiliateName, AffiliationType affiliationType) {
        return switch (affiliationType) {
            case PLAYER -> {
                ...
                yield player == null
                        ? new LiteralText((affiliateName)).formatted(GRAY).append(" ").append(new TranslatableText("cli.msg.info.player.list.entry.offline"))
                        : buildPlayerHoverComponent(player);
            }
            case TEAM -> {
                Team team = RegionDataManager.serverInstance.getScoreboard().getPlayerTeam(affiliateName);
                yield team == null ? new LiteralText((affiliateName)) : buildTeamHoverComponent(team);
            }
        };
    }
    ...
    public static MutableText buildRegionRemoveChildLink(IProtectedRegion region, IProtectedRegion child) {
        ...
        MutableText linkText = new TranslatableText("cli.link.remove");
        MutableText linkHoverText = new TranslatableText("cli.msg.info.region.children.remove.link.hover", child.getName(), region.getName());
    ...
    public static MutableText buildRegionActionUndoLink(String cmd, CommandConstants toReplace, CommandConstants replacement) {
        ...
        MutableText revertLinkText = new TranslatableText("cli.link.action.undo.text");
        MutableText revertLinkHover = new TranslatableText("cli.link.action.undo.hover");
    ...
    public static MutableText buildFlagHeader(IProtectedRegion region, RegionType regionType) {
        return switch (regionType) {
            case DIMENSION ->
                    buildHeader(new TranslatableText("cli.msg.info.header.in", buildFlagListLink(region, regionType), buildRegionInfoLink(region, regionType)));
            case LOCAL ->
                    buildHeader(new TranslatableText("cli.msg.info.header.in", buildFlagListLink(region, regionType), buildRegionInfoLink(region, regionType)));

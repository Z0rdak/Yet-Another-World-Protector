...
public class MessageUtil {
    ...
    public static MutableComponent buildRegionEnableComponent(IMarkableRegion region) {
        ...
        return buildExecuteCmdComponent(text, hover, cmd, RUN_COMMAND, color);
    }
    ...
    public static MutableComponent buildStateLink(IProtectedRegion region) {
        ...
        MutableComponent stateLink = buildExecuteCmdComponent(text, hover, command, RUN_COMMAND, color);

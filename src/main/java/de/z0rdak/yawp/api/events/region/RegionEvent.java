...
public abstract class RegionEvent {
     ...
     */
    public final static class RenameRegion extends RegionEvent {
         ...
         * @see de.z0rdak.yawp.managers.data.region.RegionDataManager#isValidRegionName(net.minecraft.registry.RegistryKey, String)
         */

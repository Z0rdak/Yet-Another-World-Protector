                                                ...
                                                .then(CommandManager.literal(AreaType.CUBOID.areaType)
                                                        .then(CommandManager.argument(POS1.toString(), BlockPosArgumentType.blockPos())
                                                                .then(CommandManager.argument(POS2.toString(), BlockPosArgumentType.blockPos())
                                                                        .executes(ctx -> setCuboidArea(ctx, getRegionArgument(ctx), BlockPosArgumentType.getValidBlockPos(ctx, POS1.toString()), BlockPosArgumentType.getValidBlockPos(ctx, POS2.toString()))))))
                                                .then(CommandManager.literal(AreaType.SPHERE.areaType)
                                                        .then(CommandManager.argument(CENTER_POS.toString(), BlockPosArgumentType.blockPos())
                                                                .then(CommandManager.argument(RADIUS_POS.toString(), BlockPosArgumentType.blockPos())
                                                                        .executes(ctx -> setSphereArea(ctx, getRegionArgument(ctx), BlockPosArgumentType.getValidBlockPos(ctx, CENTER_POS.toString()), BlockPosArgumentType.getValidBlockPos(ctx, RADIUS_POS.toString()))))))
                                                .then(CommandManager.literal(AreaType.SPHERE.areaType)
                                                        .then(CommandManager.argument(CENTER_POS.toString(), BlockPosArgumentType.blockPos())
                                                                .then(CommandManager.argument(RADIUS.toString(), IntegerArgumentType.integer(0))
                                                                        .executes(ctx -> setSphereArea(ctx, getRegionArgument(ctx), BlockPosArgumentType.getValidBlockPos(ctx, CENTER_POS.toString()), IntegerArgumentType.getInteger(ctx, RADIUS.toString()))))))
                                        )
                                        .then(literal(EXPAND)
                                                .then(CommandManager.literal(AreaType.CUBOID.areaType)
                                        ...
                                        .then(literal(TELEPORT)
                                                .then(CommandManager.literal(SET.toString())
                                                        .then(CommandManager.argument(TARGET.toString(), BlockPosArgumentType.blockPos())
                                                                .executes(ctx -> setTeleportPos(ctx, getRegionArgument(ctx), BlockPosArgumentType.getValidBlockPos(ctx, TARGET.toString())))))
                                        )
                                        .then(literal(TELEPORT)

...
public class AreaArgumentType implements ArgumentType<AreaType> {
    ...
    private static final SimpleCommandExceptionType ERROR_AREA_INVALID = new SimpleCommandExceptionType(new TranslatableText("cli.arg.area.parse.invalid"));

    private static final DynamicCommandExceptionType ERROR_INVALID_VALUE = new DynamicCommandExceptionType(
            flag -> new TranslatableText("cli.arg.area.invalid", flag)
    );

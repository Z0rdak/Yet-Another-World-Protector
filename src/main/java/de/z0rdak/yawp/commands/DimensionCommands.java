...
public class DimensionCommands {
    ...
    private static int createCuboidRegion(CommandContext<ServerCommandSource> ctx, String regionName, DimensionRegionCache dimCache, BlockPos pos1, BlockPos pos2, @Nullable IProtectedRegion parentRegion) {
    ...
    private static int createSphereRegion(CommandContext<ServerCommandSource> ctx, String regionName, DimensionRegionCache dimCache, BlockPos centerPos, BlockPos radiusPos, @Nullable IProtectedRegion parentRegion) {
        SphereRegion region = new SphereRegion(regionName, new SphereArea(centerPos, radiusPos), null, dimCache.dimensionKey());
        IProtectedRegion parent = parentRegion == null ? dimCache.getDimensionalRegion() : parentRegion;
        return createRegion(ctx, regionName, dimCache, region, parent);
    }

    private static int createSphereRegion(CommandContext<ServerCommandSource> ctx, String regionName, DimensionRegionCache dimCache, BlockPos centerPos, int radius, @Nullable IProtectedRegion parentRegion) {

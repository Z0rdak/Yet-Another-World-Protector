...
public final class ConfigRegistry {
    ...
    private static void onModReloading(net.neoforged.fml.config.ModConfig modConfig) {
        if (modConfig.getModId().equals(MODID)) {
            YetAnotherWorldProtector.LOGGER.info("Reloaded: '" + modConfig.getFileName() + "'");
        }
    }

    private static void onModLoading(net.neoforged.fml.config.ModConfig modConfig) {
        if (modConfig.getModId().equals(MODID)) {

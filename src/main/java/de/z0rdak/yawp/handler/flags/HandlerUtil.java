...
public final class HandlerUtil {
     ...
     */
    public static IProtectedRegion getResponsible(BlockPos pos, ResourceKey<Level> dim) {
     ...
     */
    public static FlagState getFlagState(IProtectedRegion region, RegionFlag flag, @Nullable Player player) {
        if (player == null) {

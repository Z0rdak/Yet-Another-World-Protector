...
public class SphereArea extends CenteredArea {
    ...
    public Set<BlockPos> getHull() {
        AABB cube = new AABB(new BlockPos(this.center).offset(-this.radius, -this.radius, -this.radius), new BlockPos(this.center).offset(this.radius, this.radius, this.radius));

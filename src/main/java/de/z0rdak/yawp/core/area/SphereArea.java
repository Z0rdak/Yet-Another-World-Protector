...
public class SphereArea extends CenteredArea {
    ...
    public Set<BlockPos> getHull() {
        BlockPos offsetNegative = new BlockPos(-this.radius, -this.radius, -this.radius);
        BlockPos offsetPositive = new BlockPos(this.radius, this.radius, this.radius);
        AABB cube = new AABB(offsetNegative.getX(), offsetNegative.getY(), offsetNegative.getZ(), offsetPositive.getX(), offsetPositive.getY(), offsetPositive.getZ());
    ...
    public boolean intersects(CuboidArea other) {
        ...
        int closestX = (int) Math.max(other.getArea().minX, Math.min(this.center.getX(), other.getArea().maxX));
        int closestY = (int) Math.max(other.getArea().minY, Math.min(this.center.getY(), other.getArea().maxY));
        int closestZ = (int) Math.max(other.getArea().minZ, Math.min(this.center.getZ(), other.getArea().maxZ));

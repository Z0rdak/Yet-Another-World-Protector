...
public class SphereArea extends CenteredArea {
    ...
    public Set<BlockPos> getHull() {
        AxisAlignedBB cube = new AxisAlignedBB(new BlockPos(this.center).offset(-this.radius, -this.radius, -this.radius), new BlockPos(this.center).offset(this.radius, this.radius, this.radius));
    ...
    public boolean intersects(CuboidArea other) {
        ...
        double closestX = Math.max(other.getArea().minX, Math.min(this.center.getX(), other.getArea().maxX));
        double closestY = Math.max(other.getArea().minY, Math.min(this.center.getY(), other.getArea().maxY));
        double closestZ = Math.max(other.getArea().minZ, Math.min(this.center.getZ(), other.getArea().maxZ));

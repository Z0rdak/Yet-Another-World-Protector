...
import de.z0rdak.regionshield.common.core.region.AbstractMarkableRegion;
import de.z0rdak.regionshield.common.core.region.CuboidRegion;
import de.z0rdak.regionshield.common.core.region.IProtectedRegion;
...
public class RegionShield
{
    ...
    {
        // some preinit code
        AbstractMarkableRegion region = new CuboidRegion("test", new AxisAlignedBB(new BlockPos(0,0,0),new BlockPos(1,1,1)), RegistryKey.create(Registry.DIMENSION_REGISTRY, new ResourceLocation("minecraft:overworld")));
        region.setPriority(50);
        region.setIsMuted(false);
        region.setTpTarget(new BlockPos(2,2,2));
    ...
    // TODO: icon
    // TODO: client only loading
    @OnlyIn(Dist.CLIENT)
    public static final ItemGroup REGION_SHIELD_TAB = new ItemGroup(MODID) {
        @Override
